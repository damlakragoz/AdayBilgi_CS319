    ...
    return (
        <div className="puantage-container">
            ...
            <div className="tour-list-container">
                <h3>{selectedDate.toLocaleDateString("tr-TR")} Tarihindeki Turlar</h3>
                {filteredTours.length > 0 ? (
                    ...
                    <p>Seçilen Tarih için aktif bir tur yok.</p>
                )}
            </div>
            ...
            {selectedTour && (
                <div className="activity-input-container">
                    ...
                    >
                        {selectedTour.tourStatus === "Finished" ? "Aktiviteyi Düzenle" : "Aktiviteyi Gönder"}
                    </button>
                </div>
            )}
