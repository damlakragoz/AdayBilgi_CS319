...
import FuarBasvurularim from "./FuarBasvurularim";
import "../coordinatorPages/BTOKoordinasyonu.css";


const AllApplicationsCounselor = ({ data = [], itemsPerPage = 5 }) => {
...
// Default Props
AllApplicationsCounselor.defaultProps = {
  data: [],
  itemsPerPage: 5,
};

export default AllApplicationsCounselor;
