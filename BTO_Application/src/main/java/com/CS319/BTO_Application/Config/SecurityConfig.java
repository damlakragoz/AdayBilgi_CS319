    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login","/api/auth/user-role","/api/counselor/register", "/api/BTOMember/register").permitAll() // Allow unauthenticated access to the login endpoint
