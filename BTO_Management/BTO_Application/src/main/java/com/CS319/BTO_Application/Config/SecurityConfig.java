    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login", "/api/auth/user-role", "/api/advisor/*","/api/tour/*","/api/*/register","/api/school/getCounselors","/api/*/delete", "/api/*/getAll","/api/*/*/getAll, /api/user/changePassword").permitAll() // Allow unauthenticated access to the login endpoint
