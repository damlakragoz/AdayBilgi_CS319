...
const ChangePassword = () => {
    try {
        console.log("Rendering ChangePassword Component");  // Debugging line
        ...
        return (
            <div className="change-password-container">
                ...
                <form onSubmit={handleSubmit}>
                    <input type="email" placeholder="Mevcut şifrenizi giriniz" required/>
                    ...
                    <div className="form-group">
                        ...
                        <input type="email" placeholder="Yeni şifrenizi giriniz" required/>
        ...
        console.error("Error rendering ChangePassword component:", error);
    }
};
